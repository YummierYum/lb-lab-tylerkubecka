...
partB.txt:
	man man | grep -m1 "DESCRIPTION" -A4 > partB.txt
	man grep | grep -m1 "DESCRIPTION" -A3 >> partB.txt
...
pointers: pointers.o
	$(CC) $(CFLAGS) -DPOINTERS main.c pointers.c -o runner
	./runner

strings: strings.o
	$(CC) $(CFLAGS) -DSTRINGS main.c strings.c -o runner
	./runner

structs: structs.o
	$(CC) $(CFLAGS) -DSTRUCTS main.c structs.c -o runner
	./runner
